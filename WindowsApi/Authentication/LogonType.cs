namespace Wanderer.Library.WindowsApi.Authentication
{
    ...
    internal enum LogonType
    {
        ...
        /// The <see cref="NativeMethods.LogonUser(string, string, string, LogonType, LogonProvider)"/>
        ...
        /// call <see cref="NativeMethods.LogonUser(string, string, string, LogonType, LogonProvider)"/>,
